import { Box, Flex ,Input,Text,InputGroup, InputRightElement, Button, useDisclosure} from '@chakra-ui/react';
...
const PostFooter = ({post,username,isProfilePage,creatorProfile}) => {
  ...
  <Flex alignItems={"center"} gap={4} pt={0}mt={4} mb={2}>
  ...
  {authUser && (
    <Flex
    alignItems={"center"} gap={2} justifyContent={"space-between"} w={"full"}>
      <InputGroup>
